...
async def run_benchmark_with_qdrant(limit: int = 1000, results_dir: Optional[Path] = None, k: int = 2, m: int = 5, top_k: int = 10, **kwargs):
    """
        ...
        if "answer" in question_data:
            try:
                ...
                params = {
                    ...
                    "k": k,  # Usar el valor recibido como parámetro
                    "seed": 23,
                    "client": ollama_client,
                    "drafter_model": DRAFTER_MODEL,
                    "verifier_model": VERIFIER_MODEL,
                    "m": m,  # Usar el valor recibido como parámetro
                    "top_k": top_k,  # Usar el valor recibido como parámetro
                    "verbose": False,
                    "debug_prints": True,
                ...
                # Agregar cualquier otro parámetro incluido en kwargs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit", type=int, default=1000, help="Número máximo de preguntas a evaluar")
