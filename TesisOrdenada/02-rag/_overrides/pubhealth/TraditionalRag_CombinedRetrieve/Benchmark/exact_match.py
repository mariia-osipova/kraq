...
def extract_label(text: str) -> str:
    ...
    También maneja casos donde la etiqueta está entre <>.
    ...
    if match:
        # Normalizar la etiqueta (quitar <>, espacios extra y convertir a minúsculas)
        label = match.group(1).strip().lower()
        # Quitar cualquier < o > restante por si acaso
...
def main():
    ...
    results_dir = Path(__file__).parent.parent / "Benchmark" / "results_random"
