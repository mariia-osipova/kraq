...
async def run_traditional_rag_test():
    """
    Ejecuta pruebas de Traditional RAG con timing detallado
    """
    logger.info("Iniciando prueba de Traditional RAG usando modelos locales")
    ...
    for i, question in enumerate(TEST_QUESTIONS, 1):
        ...
        try:
            ...
            response = await traditional_rag(
                query=question,
                ...
                debug_prints=True,
                verbose_timing=True,
                collection_name="chunks"  # Cambiado a "chunks" por defecto
            )
...
if __name__ == "__main__":
    asyncio.run(run_traditional_rag_test()) 