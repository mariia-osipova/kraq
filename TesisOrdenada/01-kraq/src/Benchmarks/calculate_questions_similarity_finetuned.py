...
# Nombre de la colección específica para preguntas del modelo finetuned
...
def calculate_and_save_proximities():
    """Calcula la similitud entre preguntas del benchmark y las almacenadas en Qdrant (modelo finetuned)."""
    print("=== Iniciando proceso de similitud (Modelo Finetuned) ===")
    ...
    try:
        ...
        if resultados:
            ...
            # Guardar resultados
            output_path = os.path.join(project_root, "output", "similitudes_finetuned.json")
            ...
            print("\n=== Estadísticas de Similitud (Modelo Finetuned) ===")
...
if __name__ == "__main__":
    print("Comenzando benchmark para modelo finetuneado (questions-index-finetuned)")
